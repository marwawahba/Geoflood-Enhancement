...
def compute_segment_slope(m_array, z_array, step=10):
    ...
    لو الميل صفر أو سالب يتم استبداله بأقل قيمة مسموح بها (0.00001).
    إرجاع الوسيط بدل المتوسط.
    """
